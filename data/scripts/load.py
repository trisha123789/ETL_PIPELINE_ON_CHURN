...
def create_table_if_not_exists():
    ...
    Ensures the customer_churn table exists in Supabase.
    ...
    contract_type_code INTEGER
        ...
        try:
            ...
            print("✅ Table 'customer_churn' created or already exists")
...
def load_to_supabase(staged_path: str, table_name: str = "customer_churn"):
    ...
    Args:
        ...
        table_name (str): Supabase table name. Default is 'customer_churn'.
